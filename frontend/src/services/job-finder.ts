  ...
  const mockJobsBase = [
    {
      ...
      originalUrl: "https://vietnamworks.com/jobs/1",
      company: {
        name: "Amaras",
    ...
    },
    {
      ...
      originalUrl: "https://vn.indeed.com/jobs/2",
      company: {
        name: "Microsoft",
    ...
    },
    {
      ...
      company: {
        ...
        description: "### About Grab\n\nGrab is Southeast Asia's leading superapp, providing a wide range of services including ride-hailing, food delivery, and digital payments. We are committed to driving Southeast Asia forward by creating economic empowerment for everyone.\n\n### Our Culture\n\nAt Grab, we believe in the power of technology to improve lives. We are a diverse team of innovators and problem solvers who are passionate about making a difference in our communities. We value collaboration, integrity, and a customer-first mindset."
      },
      location: "On-site / Sinapore",
    ...
    },
    {
      ...
      originalUrl: "https://example.com/jobs/4",
      company: {
        name: "Facebook",
        ...
        description: "### About Facebook\n\nFacebook is a global social media and technology company that connects billions of people around the world. Our mission is to give people the power to build community and bring the world closer together.\n\n### Our Culture\n\nAt Facebook, we value innovation, collaboration, and a commitment to making a positive impact on the world. We believe in open communication, continuous learning, and a diverse workforce."
      },
      location: "Remote / Austin",
      datePosted: new Date("2025-05-01"),
      skills: [],
      // skills: ["Python", "R", "SQL", "Machine Learning", "Data Visualization", "TensorFlow", "Pandas", "NumPy"],
      jobDescription: "As a Data Scientist at Facebook, you will work with large datasets to derive insights and build predictive models that drive business decisions. You will collaborate with cross-functional teams to identify opportunities for leveraging data to improve our products and services.\n\n### Responsibilities\n\n* Analyze large datasets to extract meaningful insights\n* Build and deploy machine learning models\n* Collaborate with product managers and engineers to define metrics and KPIs\n* Communicate findings and recommendations to stakeholders\n* Conduct A/B testing and analyze results\n* Stay up-to-date with the latest research in data science and machine learning",
      jobRequirements: "### Qualifications\n\n* Bachelor's degree in Computer Science, Statistics, Mathematics, or related field\n* 3+ years of experience in data science or related field\n* Strong programming skills in Python or R\n* Experience with SQL and data manipulation\n* Familiarity with machine learning algorithms and frameworks (e.g., TensorFlow, PyTorch)\n* Strong analytical and problem-solving skills\n* Excellent communication and presentation skills\n\n### Preferred Qualifications\n\n* Experience with big data technologies (e.g., Hadoop, Spark)\n* Knowledge of data visualization tools (e.g., Tableau, Power BI)\n* Experience with cloud platforms (e.g., AWS, Google Cloud)\n* Contributions to open-source projects",
      type: "Internship",
      level: "Entry-level",
      salary: "$70K - $90K",
      benefit: "### Benefits & Perks\n\n* **Health & Wellness**\n  * Comprehensive health insurance\n  * On-site fitness centers\n  * Mental health resources\n  * Wellness programs and incentives\n\n* **Workspace**\n  * Modern, collaborative workspace\n  * Latest hardware and software\n  * Remote work flexibility\n  * Employee resource groups\n\n* **Professional Development**\n  * Learning & development budget\n  * Internal hackathons and innovation contests\n  * Mentorship opportunities\n  * Conference attendance\n\n* **Financial Benefits**\n  * Competitive compensation\n  * 401(k) matching\n  * Stock purchase plan\n  * Performance bonuses",
    ...
    // generate small company (no popular) 4 ones
    {
      id: "5",
      title: "Backend Software Engineer",
      originalUrl: "https://example.com/jobs/5",
      company: {
        name: "Tech Inno",
        logo: "https://example.com/logo.png",
        address: "New York, NY",
        description: "### About Tech Innovators\n\nTech Innovators is a fast-growing startup focused on developing cutting-edge technology solutions for businesses. We are passionate about innovation and are looking for talented individuals to join our team."
      },
      location: "On-site / New York",
      datePosted: new Date("2025-05-10"),
      skills: [],
      // skills: ["Java", "Spring", "MySQL", "REST APIs", "Microservices"],
      jobDescription: "As a Software Engineer at Tech Innovators, you will be responsible for designing and implementing software solutions that meet the needs of our clients. You will work closely with product managers and designers to create high-quality software products.",
    ...
    },
    {
      ...
      originalUrl: "https://example.com/jobs/6",
      company: {
        name: "Creativestor",
        logo: "https://example.com/logo.png",
        address: "Los Angeles, CA",
        description: "### About Creative Solutions\n\nCreative Solutions is a marketing agency that specializes in helping businesses grow through innovative marketing strategies. We are looking for a Marketing Specialist to join our team."
      },
      location: "Remote / Los Angeles",
      datePosted: new Date("2025-05-15"),
      skills: [],
      // skills: ["SEO", "Content Marketing", "Social Media", "Google Analytics"],
      jobDescription: "As a Marketing Specialist at Creative Solutions, you will be responsible for developing and implementing marketing strategies that drive traffic and engagement. You will work closely with clients to understand their needs and create tailored marketing plans.",
      jobRequirements: "### Qualifications\n\n* Bachelor's degree in Marketing or related field\n* 2+ years of experience in digital marketing\n* Proficiency in SEO and content marketing\n* Experience with social media platforms and Google Analytics\n* Strong analytical skills\n* Excellent communication skills",
      type: "Part-time",
      level: "Junior",
      salary: "$50K - $70K",
      benefit: "### Benefits & Perks\n\n* Competitive salary\n* Flexible work hours\n* Remote work options\n* Professional development opportunities",
    ...
    },
    {
      id: "7",
      title: "Data Analyst",
      originalUrl: "https://example.com/jobs/7",
      company: {
        name: "Data Intd",
        logo: "https://example.com/logo.png",
        address: "Chicago, IL",
        description: "### About Data Insights\n\nData Insights is a data analytics company that helps businesses make data-driven decisions. We are looking for a Data Analyst to join our team."
      },
      location: "On-site / Chicago",
      datePosted: new Date("2025-05-20"),
      skills: [],
      // skills: ["SQL", "Python", "Data Visualization", "Excel"],
      jobDescription: "As a Data Analyst at Data Insights, you will be responsible for analyzing data and providing insights that help our clients make informed decisions. You will work closely with clients to understand their data needs and create reports and dashboards.",
...
const mockDetailJobs: DetailJob[] = generateMockDetailJobs(1021);
...
const mockPromptSuggestions = [
  ...
  // generate prompt suitable for full text search (keywords, a little bit of context, eg: Java backend intership in HCM City)
  "Java backend internship in HCM City",
  "React frontend developer in Ho Chi Minh City",
  "Data analyst remote job with Python skills",
  "UI/UX designer position for beginners in Hanoi",
  "Backend engineer job in HCM City with Node.js experience",
  "Backend engineer senior position in Ho Chi Minh City",
  "Full stack developer job in Hanoi with React and Node.js",
  "Senior backend developer position in Ho Chi Minh City",
  "Full stack developer (backend focus) job in HCM City",
  "Data analyst internship in Ho Chi Minh City",
];
    ...
    return new Promise<PaginatedResponse<Job>>((resolve) => {
      setTimeout(() => {
        ...
        if (params.search) {
          ...
          if (searchLower.includes("backend") || searchLower.includes("HCM")) {
            filteredJobs = filteredJobs.filter(job =>
              job.title.toLowerCase().includes("backend") || 
              job.location.toLowerCase().includes("Ho Chi Minh") ||
              job.companyName.toLowerCase().includes("backend") ||
              job.skills?.some(skill => skill.toLowerCase().includes("backend"))
            );
          } else {
              filteredJobs = filteredJobs.filter(job => 
