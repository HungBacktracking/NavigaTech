...
Revision ID: 54b481fa431d
Revises: b6957e3c2669
Create Date: 2025-07-12 19:25:09.019117
...
revision = '54b481fa431d'
down_revision = 'b6957e3c2669'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_index('ix_job_task', 'job_tasks', ['id', 'job_id', 'user_id'], unique=True)
