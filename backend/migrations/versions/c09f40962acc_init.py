...
Revision ID: c09f40962acc
Revises: 
Create Date: 2025-05-02 03:10:59.714957
...
def upgrade():
    ...
    sa.Column('degree_type', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('is_analyze', sa.Boolean(), nullable=True),
    sa.Column('resume_url', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('location_feedback', sa.Text(), nullable=True),
    sa.Column('job_type_feedback', sa.Text(), nullable=True),
    ...
    op.create_table('jobpref',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('desired_title', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('desired_location', sa.ARRAY(sa.String()), nullable=True),
    sa.Column('job_type', sa.ARRAY(sa.String()), nullable=True),
...
def downgrade():
    ...
    op.drop_table('jobpref')
    op.drop_table('jobanalytics')
