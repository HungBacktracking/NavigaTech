...
class Job(BaseModel, table=True):
    job_url: str = Field(default=None, nullable=True)
    logo_url: str = Field(default=None, nullable=True)
    ...
    job_description: str = Field(default=None, sa_column=Column(Text, nullable=True))
    job_requirement: str = Field(default=None, sa_column=Column(Text, nullable=True))
